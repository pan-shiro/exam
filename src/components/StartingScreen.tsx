...
export default function StartingScreen({ categories, onSelectOptionChange, onStartQuizBtnClick, selectedCategory }: StartingScreenProps) {
    return (
        <section className="w-1/2 p-2 mx-auto bg-slate-100 rounded-lg shadow-xl">
            ...
            <div className="py-2 px-4">
                ...
                <div className="mt-10 flex gap-8 items-center">
                    <SelectCategories categories={categories} onSelectOptionChange={onSelectOptionChange} selectedCat={selectedCategory} />
